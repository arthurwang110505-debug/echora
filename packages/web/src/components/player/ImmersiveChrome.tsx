...
// Transport only.
//
// This bar used to carry 歌單 (back to playlist), 設定 (a popover with the animation picker,
// background picker, tuning entry, lyrics status, offset controls and 退出全螢幕). All of that
// now lives in the floating control panel — the same 歌曲資訊 / 歌詞資訊 / 播放控制 / 播放佇列 /
// 帳戶資訊 panel as the normal player page — so the bar keeps nothing but play/pause and skip.
// 退出全螢幕 has its own single-button bar (StageExitBar).
//
