...
export const LOCAL_DEMO_LYRICS: Record<string, LyricData> = {
  ...
  'demo-sun-beneath-a-song': createTranscribedLyrics('Sun Beneath a Song', 'Suryanatta', [
    ...
    [69.1, 81.28, 'Each refrain holds a spark inside.'],
  ...
  'demo-stardust-pop-idol': createTranscribedLyrics('Stardust Pop Idol', 'Kaazoom', [
    ...
    [35.6, 45.72, 'は私の番だよって胸の奥で叫んでる。STARDUST POP IDOL。'],
    [45.92, 55.94, 'このステージで光になれ。手を伸ばしてジャンプして星をつかみに行こう'],
    [55.94, 66.78, '。Wow Wow。STARDUST POP IDOL。名前呼ぶ声、風になる。泣き虫だった昨日まで'],
    ...
    [97.32, 107.8, 'したい。STARDUST POP IDOL。スポットライト浴びる日まで。転んでもね'],
    [107.8, 118.36, '、笑えばいい。涙ごとダンスしよう。Hey Hey Hey。STARDUST POP IDOL。ハートビートが合図'],
    [118.36, 141.359, 'になる。まだ届かない歓声も胸の中で響いてるから。静'],
    [141.36, 151.38, 'かになったフロア。聞こえるのは息だけ。一つ深呼吸して目を閉'],
    [151.38, 176.88, 'じて願い事。STARDUST'],
    [176.88, 187.12, 'POP IDOL。このステージで光になれ。手を伸ばしてジャンプして星をつかみに'],
    [187.12, 197.84, '行こう。Wow Wow Wow。STARDUST POP IDOL。名前呼ぶ声、風になる。今日の奇跡、明'],
    [197.84, 207.94, '日の夢、全部全部歌い尽くすよ。STARDUST POP IDOL。声枯れるまで笑い'],
    [207.94, 217.95, 'たい。指さしてね。ここにいる。あなたのためのヒロイン。Hey Hey Hey。STARDUST POP'],
