...
## Stage performance and recovery follow-up
...
- [x] SONNET-LYRICS-003：Sonnet reusable inactive Text trees 在 shot／paragraph 切換後仍保持可渲染，prune／destroy 才釋放資源；背景、幾何、guide、particle、halo、post-process、transition 與 shot motion 全部保留，並完成 cross-shot local proof、full release gate、GitHub master push 與 Vercel production verification。
